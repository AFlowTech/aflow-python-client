...
[源码地址](https://github.com/AFlowTech/aflow-python-client)
[>>使用文档](https://cifgtqpgrh.feishu.cn/wiki/IlpbwqsCpin7yOkLpoZcrnqpnmw)
...
# 安装指定版本/标签
pip install git+https://github.com/AFlowTech/aflow-python-client.git@1.0.x
